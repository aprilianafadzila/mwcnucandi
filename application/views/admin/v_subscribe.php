              ...
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        ...
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_subscribe;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
				<?php endforeach;?>
                </tbody>
...
<!--Modal Add Pengguna-->
	...
	<!--Modal Hapus Pengguna-->
        <div class="modal fade" id="ModalHapus<?php echo $id_subscribe;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/subscribe/hapus_inbox'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id_subscribe;?>"/>
