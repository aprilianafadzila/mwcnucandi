...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $('.category').change(function(){ 
                ...
                $.ajax({
                    url : "<?php echo site_url('admin/tulisan/get_sub_category');?>",
                    method : "POST",
                    data : {id: id},
                    async : true,
                    dataType : 'json',
                    success: function(data){
                        ...
                        $.each(data, function(key, value) {
                            if(subcategory_id==value.id){
                                $('select[name="sub_category"]').append('<option value="'+ value.id +'" selected>'+ value.nama +'</option>').trigger('change');
                            }else{
                                $('select[name="sub_category"]').append('<option value="'+ value.id +'">'+ value.nama +'</option>');
                            }
                        });
      ...
      //load data for edit
            function get_data_edit(){
              ...
              $.ajax({
                url : "<?php echo site_url('admin/tulisan/get_data_edit');?>",
                    method : "POST",
                    ...
                    success : function(data){
                        $.each(data, function(i, item){
                            $('[name="xjudul"]').val(data[i].tulisan_judul);
                            $('[name="category"]').val(data[i].id_jenis_kategori).trigger('change');
                            $('[name="sub_category"]').val(data[i].id_ranting).trigger('change');
