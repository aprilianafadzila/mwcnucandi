    ...
    <div class="container animate-box">
        <div class="row">
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <a href="<?php echo site_url('rantingcandi/'.$row->tulisan_slug);?>" class="footer_post pb-4"> <?php echo limit_words($row->tulisan_judul,3).'...';?> </a>
              <?php endforeach;?>
            </div>
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a href="rantingcandi" class="footer_last_part_menu">Latest News</a></div>
        </div>
    </div>
</div>
