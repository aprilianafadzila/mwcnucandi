                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box"><br><br>
                        ...
                        <div class="fh5co_consectetur"> <?php echo limit_words($row->tulisan_isi,30).'...';?>
                          ...
                          <a href="<?php echo site_url('rminu/'.$row->tulisan_slug);?>" class="btn academy-btn btn-sm mt-15">Read More</a>
                    </div>
                </div>
                <nav>
    ...
    <div class="container animate-box">
        <div class="row">
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <a href="<?php echo site_url('rminu/'.$row->tulisan_slug);?>" class="footer_post pb-4"> <?php echo limit_words($row->tulisan_judul,3).'...';?> </a>
              <?php endforeach;?>
            </div>
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a href="rminu" class="footer_last_part_menu">Latest News</a></div>
        </div>
    </div>
</div>
