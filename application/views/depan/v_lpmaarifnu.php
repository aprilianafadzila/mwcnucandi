            ...
            <div class="row">
               ...
               <div class="mx-0" style="display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -ms-flex-wrap: wrap; margin-right: -15px; margin-left: -15px;">
                    ...
                    <div style=" height: 180px; overflow: hidden; width: 100%; position: relative;"><img src="images/2.png" alt="img"/>
                        ...
                        <div style="position: absolute; width: 100%; height: 100%; color: #fff; z-index: 7; top: 50%; left: 5%; padding: 0 10px;">
                            <div class=""><a href="#" class="color_fff"> <i class=" "></i></a></div>
                            <div class=""><a href="single.html" style="font-size: 14px; color:#ffffff;"> e </a></div>
                        </div>
                    </div>
                </div>
                </div>
            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        ...
                        <h6 style="background:#00702d; padding: 10px 15px; -moz-transition: all .5s ease;-o-transition: all .5s ease;-webkit-transition: all .5s ease; -ms-transition: all .5s ease; transition: all .5s ease; display: inline-block; height: 30px;"><a class="text-white">Lp Maarif NU</h6>
                    ...
                    <div class="col-md-7 animate-box"><br><br>
                        ...
                        <div class="fh5co_consectetur"> <?php echo limit_words($row->tulisan_isi,30).'...';?>
                          ...
                          <a href="<?php echo site_url('lpmaarifnu/'.$row->tulisan_slug);?>" class="">Read More</a>
                    </div>
                </div>
                <nav>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
              ...
              <div class="row pb-3">
                  ...
                  <div class="col-7 paddding">
                    <div class="most_fh5co_treding_font"><a href="<?php echo site_url('lpmaarifnu/'.$row->tulisan_slug);?>"><?php echo limit_words($row->tulisan_judul,3).'...';?></a></div>
...
<div class="row mx-0 animate-box" data-animate-effect="fadeInUp">
    <div class="col-12 text-center pb-4 pt-4">
        ...
        <a href="lpbhnu" class="btn_mange_pagging">Next <i class="fa fa-long-arrow-right"></i>&nbsp;&nbsp; </a>
     </div>
</div>
</div>
</div>
