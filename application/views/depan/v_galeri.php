            ...
            <div class="fh5co_suceefh5co_height">
              <div class="course-content">
                ...
                <div class="ribbons"></div>
                    ...
                    <img src="<?php echo base_url() ?>assets/images/6c1b59f195ef40d60672cd41da4fac11.jpg" alt="" class="col-12" widht="200px;" title="" />
            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        ...
                        <h6 style="background:#4dab73; padding: 10px 15px; -moz-transition: all .5s ease;-o-transition: all .5s ease;-webkit-transition: all .5s ease; -ms-transition: all .5s ease; transition: all .5s ease; display: inline-block; height: 30px;">Galeri</h6>
                    ...
                    <div class="col-md-7 animate-box"><br><br>
                        ...
                        <div class="c_g"><i class="fa fa-user"aria-hidden="true"></i><span> <?php echo $row->tulisan_author;?> | <?php echo $row->tulisan_tanggal;?> | </span></div>
                        <div class="fh5co_consectetur"> <?php echo limit_words($row->tulisan_isi,30).'...';?>
                        </div>
                          <a href="<?php echo site_url('galeri/'.$row->tulisan_slug);?>" class="btn academy-btn btn-sm mt-15">Read More</a>
                    </div>
                </div>
                <nav>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-7 paddding">
                        ...
                        <div class="most_fh5co_treding_font_123"><i class="fa fa-user" aria-hidden=""></i>  <?php echo $row->tulisan_author;?></div>
...
<div class="row mx-0 animate-box" data-animate-effect="fadeInUp">
    <div class="col-12 text-center pb-4 pt-4">
        ...
        <a href="aswaja" class="btn_mange_pagging">Next <i class="fa fa-long-arrow-right"></i>&nbsp;&nbsp; </a>
     </div>
</div>
</div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-4">
              <?php foreach ($profil->result() as $row) : ?>
                ...
                <div class="footer_sub_about pb-3"> <?php echo $row->tulisan_isi;?>
                </div>
              <?php endforeach;?>
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <a href="<?php echo site_url('galeri/'.$row->tulisan_slug);?>" class="footer_post pb-4"> <?php echo limit_words($row->tulisan_judul,3).'...';?> </a>
              <?php endforeach;?>
            </div>
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a href="galeri" class="footer_last_part_menu">Latest News</a></div>
        </div>
    </div>
</div>
