            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        ...
                        <h6 style="background:#00702d; padding: 10px 15px; -moz-transition: all .5s ease;-o-transition: all .5s ease;-webkit-transition: all .5s ease; -ms-transition: all .5s ease; transition: all .5s ease; display: inline-block; height: 30px;"><a class="text-white">Rantingsumokali</h6>
                    ...
                    <div class="col-md-7 animate-box"><br><br>
                        ...
                        <div class="fh5co_consectetur"> <?php echo limit_words($row->tulisan_isi,30).'...';?>
                          ...
                          <a href="<?php echo site_url('rantingsumokali/'.$row->tulisan_slug);?>" class="">Read More</a>
                    </div>
                </div>
                <nav>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
              ...
              <div class="row pb-3">
                  ...
                  <div class="col-7 paddding">
                    <div class="most_fh5co_treding_font"><a href="<?php echo site_url('rantingsumokali/'.$row->tulisan_slug);?>"><?php echo limit_words($row->tulisan_judul,3).'...';?></a></div>
