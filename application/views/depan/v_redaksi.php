            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        ...
                        <h6 style="background:#4dab73; padding: 10px 15px; -moz-transition: all .5s ease;-o-transition: all .5s ease;-webkit-transition: all .5s ease; -ms-transition: all .5s ease; transition: all .5s ease; display: inline-block; height: 30px;">Redaksi</h6>
    ...
    <div class="container animate-box">
        <div class="row">
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <a href="<?php echo site_url('redaksi/'.$row->tulisan_slug);?>" class="footer_post pb-4"> <?php echo limit_words($row->tulisan_judul,3).'...';?> </a>
      <?php endforeach;?>
            </div>
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a href="redaksi" class="footer_last_part_menu">Latest News</a></div>
        </div>
    </div>
</div>
