                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box"><br><br>
                        ...
                        <div class="fh5co_consectetur"> <?php echo limit_words($row->tulisan_isi,30).'...';?>
                          ...
                          <a href="<?php echo site_url('aswaja/'.$row->tulisan_slug);?>" class="">Read More</a>
                    </div>
                </div>
                <nav>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
              ...
              <div class="row pb-3">
                  ...
                  <div class="col-7 paddding">
                    <div class="most_fh5co_treding_font"><a href="<?php echo site_url('aswaja/'.$row->tulisan_slug);?>"><?php echo limit_words($row->tulisan_judul,3).'...';?></a></div>
...
<div class="container-fluid fh5co_video_news_bg pb-4" style="background:#ffffff; ">
    <div class="container animate-box" data-animate-effect="fadeIn">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom pt-5 pb-2 mb-4  text-black">VIDEO TERBARU</div>
        </div>
        <?php
...
<div class="row mx-0 animate-box" data-animate-effect="fadeInUp">
    <div class="col-12 text-center pb-4 pt-4">
        ...
        <a href="pesantren" class="btn_mange_pagging">Next <i class="fa fa-long-arrow-right"></i>&nbsp;&nbsp; </a>
     </div>
</div>
</div>
</div>
